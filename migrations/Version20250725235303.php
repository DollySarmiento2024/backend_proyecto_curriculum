 ...
 */
final class Version20250725235303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conocimiento (id INT AUTO_INCREMENT NOT NULL, id_usuario INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, nivel VARCHAR(100) DEFAULT NULL, descripcion LONGTEXT DEFAULT NULL, INDEX IDX_132CE629FCF8192D (id_usuario), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE curriculum (id INT AUTO_INCREMENT, usuario_id INT DEFAULT NULL, formacion LONGTEXT NOT NULL, experiencia LONGTEXT NOT NULL, habilidad LONGTEXT NOT NULL, idioma LONGTEXT NOT NULL, conocimiento LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_7BE2A7C3DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE conocimiento');
